...
const courses = require("./app/modules/Course/routes/courses");
const requests = require("./app/modules/Request/routes/requests");
const subjects = require("./app/modules/Subject/routes/subjects");
const projects = require("./app/modules/Project/routes/projects");
const teachers = require("./app/modules/Teacher/routes/teachers");
